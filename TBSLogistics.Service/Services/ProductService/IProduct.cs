...
namespace TBSLogistics.Service.Services.ProductServiceManage
{
    public interface IProduct
    {
        ...
        //public Task<BoolActionResult> ApproveProductServiceRequestByMaHD(ApproveProductServiceRequestByMaHD request, int statustID);
        ...
        public Task<PagedResponseCustom<ListProductServiceRequest>> GetListProductService(PaginationFilter filter);
        //public Task<PagedResponseCustom<ListProductServiceRequest>> GetListProductServiceByMaHD(PaginationFilter filter, string MaHD);
