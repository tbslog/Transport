  ...
  useEffect(() => {
    if (props && selectIdClick && Object.keys(selectIdClick).length > 0) {
      ...
      (async () => {
        ...
        handleOnchangeListRoad(data.maCungDuong);
        ...
        if (data.ptVanChuyen.includes("CONT")) {
          ...
          setValue(
            "TGLayRong",
            data.thoiGianLayRong === null
              ? null
              : new Date(data.thoiGianLayRong)
          );
          setValue(
            "TGTraRong",
            data.thoiGianTraRong === null
              ? null
              : new Date(data.thoiGianTraRong)
          );
          setValue(
            "TGLech",
            data.thoiGianHanLenh === null
              ? null
              : new Date(data.thoiGianHanLenh)
          );
          setValue(
            "TGKeoCont",
            data.thoiGianKeoCong === null
              ? null
              : new Date(data.thoiGianKeoCong)
          );
        }
        ...
        if (data.phanLoaiVanDon === "xuat") {
          ...
          setValue(
            "TGCatMang",
            data.thoiGianCatMang === null
              ? null
              : new Date(data.thoiGianCatMang)
          );
        }
            ...
            <div className="row">
              <div className="col col-sm">
                <div className="form-group">
                  ...
                  />
                  {errors.SEALNP && (
                    <span className="text-danger">{errors.SEALNP.message}</span>
                  )}
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col col-sm">
                <div className="form-group">
                  ...
                  />
                  {errors.TaiXe && (
                    <span className="text-danger">{errors.TaiXe.message}</span>
                  )}
                </div>
              </div>
              {watch(`PTVanChuyen`) && watch(`PTVanChuyen`).includes("CONT") && (
